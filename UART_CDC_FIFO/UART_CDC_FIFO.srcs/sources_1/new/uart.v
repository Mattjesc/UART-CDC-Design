...
module uart (
    ...
    // Parameters for baud rate and clock configuration
    parameter clk_value = 100_000; // Clock frequency (Hz)
    parameter baud = 9600;         // Baud rate for UART communication
    parameter wait_count = clk_value / baud; // Clock cycles per baud interval
    
    // Internal FIFO signals
    wire internal_tx_fifo_empty, internal_tx_fifo_full;
    wire internal_rx_fifo_empty, internal_rx_fifo_full;
